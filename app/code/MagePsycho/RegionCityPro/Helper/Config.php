...
class Config
{
    ...
    const XML_PATH_REGION_SORT_ORDER      = 'magepsycho_regioncitypro/region/sort_order';
    ...
    public function getRegionSortOrder($storeId = null)
    {
        return $this->getConfigValue(self::XML_PATH_REGION_SORT_ORDER, $storeId);
    }
