...
/**
 * ManageRewardCartPoints resolver, used for GraphQL request processing
 */
class ManageRewardCartPoints implements ResolverInterface
{
    ...
    /**
     * @var \Webkul\RewardSystem\Model\ResourceModel\Rewardcart\CollectionFactory
     */
        ...
        try {
            ...
            if (empty($args['ids']) || !is_array($args['ids'])) {
                throw new \Magento\Framework\Exception\LocalizedException(
                    __('Reward cart point id(s) cannot be empty.')
                );
            }
            ...
            if ($collection->getSize() == 0) {
                throw new \Magento\Framework\Exception\LocalizedException(
                    __('Reward cart point id(s) are not valid.')
                );
            }
