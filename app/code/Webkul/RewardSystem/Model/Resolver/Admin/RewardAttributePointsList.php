...
/**
 * RewardAttributePointsList resolver, used for GraphQL request processing
 */
class RewardAttributePointsList implements ResolverInterface
{
    /**
    ...
    public function resolve(
        ...
        return $this->rewardAttributeRepository->getList($searchCriteria)->__toArray();
    }
}
