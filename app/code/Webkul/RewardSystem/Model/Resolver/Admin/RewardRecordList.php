...
/**
 * RewardRecordList resolver, used for GraphQL request processing
 */
class RewardRecordList implements ResolverInterface
{
    /**
    ...
    public function resolve(
        ...
        return $this->rewardRecordRepository->getJoinedList($searchCriteria)->__toArray();
    }
}
