...
/**
 * RewardProductSpecificList resolver, used for GraphQL request processing
 */
class RewardProductSpecificList implements ResolverInterface
{
    /**
    ...
    /**
     * @var RewardproductSpecificRepositoryInterface
     */
    protected $rewardProductSpecificRepository;
    ...
    public function __construct(
        ...
        $this->rewardProductSpecificRepository = $rewardProductSpecificRepository;
    ...
    private function getItems($collection)
    {
        ...
        foreach ($data as &$item) {
            if ($item['start_time'] != "") {
                $item['start_time'] = $this->helper->getTimeAccordingToTimeZone($item['start_time']);
            }
            if ($item['end_time'] != "") {
                $item['end_time'] = $this->helper->getTimeAccordingToTimeZone($item['end_time']);
            }
        }
        return $data;
    }
