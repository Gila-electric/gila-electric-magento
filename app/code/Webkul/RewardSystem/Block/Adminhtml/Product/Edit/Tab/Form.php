<?php
/**
 * Block\Adminhtml\Product\Edit\Tab From.php
 *
 * @category Webkul
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic implements TabInterface
{
    ...
    /**
     * @var \Webkul\RewardSystem\Block\Adminhtml\Product\Edit\Tab\Grid
     */
    protected $blockGrid;
    ...
    public function initForm()
    {
        ...
        $formProduct = $this->_formFactory->create();
        $formProduct->setHtmlIdPrefix('_reward');
        $fieldset = $formProduct->addFieldset(
            'base_fieldset',
