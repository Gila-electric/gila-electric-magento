            ...
            foreach ($orders as $key => $orderItem) {
                ...
                if (is_array($replay) && isset($replay[2]) && $replay[2] == "error") {
                    ...
                    $responce .= "<p class='aramex_green'> Aramex Shipment Number: " .
                        $replay[0] . ' has been created.(' . $method . ')</p>';
                }
            }
            ...
            try {
                ...
                if ($auth_call->HasErrors) {
					...
					$data = [
                        ...
                        " <a target='_blank' style='color:red;'>Print Label #"  . $auth_call->Shipments->ProcessedShipment->ID ."</a>",
                    ...
                    if ($order->canShip() && $post['aramex_return_shipment_creation_date'] == "create") {
                        ...
                        return ([$auth_call->Shipments->ProcessedShipment->ID, $method, 'succes']);
                    } else {
