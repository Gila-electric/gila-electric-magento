define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Accept_Payments/payment/aman',
                success: false,
                iframe_url: null,
                owner: null,
                cards: null,
            ...
            afterPlaceOrder: function (data, event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: url.build('accept/methods/amanmethod'),
                    data: data,
            ...
            renderErrors: function (data) {
                ...
                $('#aman-container').show(250, function(){
                    $('#aman-errors').show(250, function(){
                        $('#aman-errors .errors').show().html(data.detail);
                    });
                });
            },
            getData: function () {
