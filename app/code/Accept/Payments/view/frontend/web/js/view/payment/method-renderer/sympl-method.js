define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Accept_Payments/payment/sympl',
                success: false,
                iframe_url: null,
                owner: null,
                cards: null,
            ...
            afterPlaceOrder: function (data, event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: url.build('accept/methods/symplmethod'),
                    data: data,
            ...
            renderErrors: function (data) {
                ...
                $('#sympl-container').show(250, function () {
                    $('#sympl-errors').show(250, function () {
                        $('#sympl-errors .errors').show().html(data.detail);
                    });
                });
            },
            getData: function () {
