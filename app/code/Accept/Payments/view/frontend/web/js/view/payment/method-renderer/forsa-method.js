define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Accept_Payments/payment/forsa',
                success: false,
                iframe_url: null,
                detail: null
            },
            afterPlaceOrder: function (data, event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: url.build('accept/methods/forsamethod'),
                    data: data,
            ...
            renderErrors: function (data) {
                ...
                $('#forsa-container').show(250, function(){
                    $('#forsa-errors').show(250, function(){
                        $('#forsa-errors .errors').show().html(data.detail);
                    });
                });
            },
            getData: function () {
