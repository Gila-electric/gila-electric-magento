define(
        ...
        function (
            ...
            return Component.extend({
                defaults: {
                    template: 'Accept_Payments/payment/valuaccept',
                    success: false,
                    iframe_url: null,
                    detail: null
                },
                afterPlaceOrder: function (data, event) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: url.build('accept/methods/valuacceptmethod'),
                        data: data,
                ...
                renderErrors: function (data) {
                    ...
                    $('#valuaccept-container').show(250, function(){
                        $('#valuaccept-errors').show(250, function(){
                            $('#valuaccept-errors .errors').show().html(data.detail);
                        });
                    });
                },
                getData: function () {
