define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Accept_Payments/payment/souhoola',
                success: false,
                iframe_url: null,
                owner: null,
                cards: null,
            ...
            afterPlaceOrder: function (data, event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: url.build('accept/methods/souhoolamethod'),
                    data: data,
            ...
            renderErrors: function (data) {
                ...
                $('#souhoola-container').show(250, function(){
                    $('#souhoola-errors').show(250, function(){
                        $('#souhoola-errors .errors').show().html(data.detail);
                    });
                });
            },
            getData: function () {
