define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Accept_Payments/payment/contact',
                success: false,
                iframe_url: null,
                owner: null,
                cards: null,
            ...
            afterPlaceOrder: function (data, event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: url.build('accept/methods/contactmethod'),
                    data: data,
            ...
            renderErrors: function (data) {
                ...
                $('#contact-container').show(250, function(){
                    $('#contact-errors').show(250, function(){
                        $('#contact-errors .errors').show().html(data.detail);
                    });
                });
            },
            getData: function () {
