define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Accept_Payments/payment/premium',
                success: false,
                iframe_url: null,
                owner: null,
                cards: null,
            ...
            afterPlaceOrder: function (data, event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: url.build('accept/methods/premiummethod'),
                    data: data,
            ...
            renderErrors: function (data) {
                ...
                $('#premium-container').show(250, function(){
                    $('#premium-errors').show(250, function(){
                        $('#premium-errors .errors').show().html(data.detail);
                    });
                });
            },
            getData: function () {
