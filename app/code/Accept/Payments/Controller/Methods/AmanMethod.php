...
class AmanMethod extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    ...
    public function __construct(
        ...
        \Accept\Payments\Model\Aman $aman,
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id = $this->aman->getConfigData('iframe_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->aman->getConfigData('api_key'),
                    "integration_id" => $this->aman->getConfigData('integration_id'),
