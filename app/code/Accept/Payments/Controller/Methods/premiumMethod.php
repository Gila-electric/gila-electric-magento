...
class premiumMethod extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    ...
    public function __construct(
        ...
        \Accept\Payments\Model\premium $premium,
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id = $this->premium->getConfigData('iframe_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->premium->getConfigData('api_key'),
                    "integration_id" => $this->premium->getConfigData('integration_id'),
