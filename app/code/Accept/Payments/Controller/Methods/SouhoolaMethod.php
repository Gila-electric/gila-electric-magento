...
class SouhoolaMethod extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    ...
    CONST ORIGIN_PRICE_STATUS = 'payment/souhoola/origin_price';
    public function __construct(
        \Magento\Framework\App\Action\Context $context,
        \Magento\Checkout\Model\Session $checkoutSession,
        \Magento\Sales\Model\Order $order,
        \Magento\Framework\App\ResourceConnection $resource,
        \Accept\Payments\Model\Souhoola $souhoola,
    ...
    )
    {
        ...
        $this->souhoola = $souhoola;
        $this->OriginPrice = $OriginPrice;
        $this->statusFactory = $statusFactory;
        $this->statusResourceFactory = $statusResourceFactory;

        // Gateway unique options
        $this->api_id = "souhoola";
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id = $this->souhoola->getConfigData('iframe_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->souhoola->getConfigData('api_key'),
                    "integration_id" => $this->souhoola->getConfigData('integration_id'),
                ...
                // islam edit
                $originPriceStatus = $this->souhoola->getConfigData('origin_price') ;
            ...
            $iframe_url =  "https://accept.paymobsolutions.com/iframe/$payment_key";
