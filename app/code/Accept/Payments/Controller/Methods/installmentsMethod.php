...
{
    CONST ORIGIN_PRICE_STATUS = 'payment/installments/origin_price';
    ...
    public function __construct(
        ...
        \Accept\Payments\Model\installments $installments,
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id =$this->installments->getConfigData('iframe_id');
                $integration_id=$this->installments->getConfigData('integration_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->installments->getConfigData('api_key'),
                ...
                // islam edit
                $originPriceStatus = $this->installments->getConfigData('origin_price') ;
