...
class SymplMethod extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    ...
    public function __construct(
        ...
        \Accept\Payments\Model\Sympl $sympl,
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id = $this->sympl->getConfigData('iframe_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->sympl->getConfigData('api_key'),
                    "integration_id" => $this->sympl->getConfigData('integration_id'),
