...
class ContactMethod extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    ...
    public function __construct(
        ...
        \Accept\Payments\Model\Contact $contact,
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id = $this->contact->getConfigData('iframe_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->contact->getConfigData('api_key'),
                    "integration_id" => $this->contact->getConfigData('integration_id'),
