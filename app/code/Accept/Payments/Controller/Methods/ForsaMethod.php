...
class ForsaMethod extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    CONST ORIGIN_PRICE_STATUS = 'payment/forsa/origin_price';
    ...
    public function __construct(
        ...
        \Accept\Payments\Model\Forsa $forsa,
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id = $this->forsa->getConfigData('iframe_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->forsa->getConfigData('api_key'),
                    "integration_id" => $this->forsa->getConfigData('integration_id'),
                 ...
                 // islam edit
                 $originPriceStatus = $this->forsa->getConfigData('origin_price') ;
