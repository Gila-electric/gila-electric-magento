...
class GetgoMethod extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    CONST ORIGIN_PRICE_STATUS = 'payment/getgo/origin_price';
    ...
    public function __construct(
        ...
        \Accept\Payments\Model\Getgo $getgo,
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id = $this->getgo->getConfigData('iframe_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->getgo->getConfigData('api_key'),
                    "integration_id" => $this->getgo->getConfigData('integration_id'),
                 ...
                 // islam edit
                 $originPriceStatus = $this->getgo->getConfigData('origin_price') ;
